...
>
	<div
		class="w-11/12 sm:w-full max-w-md absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-8 nm-flat-gray-200-xl dark:nm-flat-gray-800-xl flex flex-col items-center"
	>
